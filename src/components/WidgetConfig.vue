          ...
          <div>
            ...
            <template v-if="data.options.linkage">
              ...
              <template v-if="data.options.linkage.open">
                <el-input size="mini" style="" v-model="data.options.linkage.model">
                  <template slot="prepend">联动字段</template>
                </el-input>
                <el-input size="mini" style="" v-model="data.options.linkage.key">
            ...
            <div>
              ...
              <div>
                ...
                <el-select size="mini" v-model="data.options.props.value" placeholder="请选择">
                  <el-option
              ...
              <div>
                ...
                <el-select size="mini" v-model="data.options.props.label" placeholder="请选择">
                  <el-option
                    v-for="item in apiKeys"
                    :key="item"
                    :label="item"
